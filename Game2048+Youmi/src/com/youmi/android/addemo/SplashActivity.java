...
public class SplashActivity extends Activity {
	...
	private void runApp() {
		...
		AdManager.getInstance(mContext).init("bf079c4df33f1e81", "99ced8bafa56533c", false, false);//dengying@20161123
		//设置开屏
		setupSplashAd();
	}
	...
	private void setupSplashAd() {
		...
		// 设置跳转的窗口类
		splashViewSettings.setTargetClass(com.dream.game.MainActivity.class);//dengying@20161123
		//com.android.dream.MainActivity
		//com.dream.game.MainActivity
		//com.youmi.android.addemo.MainActivity
