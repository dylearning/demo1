...
import com.dream.sos.widget.DreamTextView;
...
public class TopBar extends ViewGroup implements OnClickListener{
    ...
    private DreamTextView mTitle;
    private DreamTextView mSubTitle;
    ...
    public TextView getTitle(){
        ...
        if(mTitle == null){
            mTitle = new DreamTextView(getContext());
    ...
    public TextView getSubTitle(){
        ...
        if(mSubTitle == null){
            mSubTitle = new DreamTextView(getContext());
