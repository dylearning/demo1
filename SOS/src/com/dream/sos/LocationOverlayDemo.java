...
//dengying@20140606 begin
import android.widget.ImageButton;
import android.widget.RelativeLayout;
import android.content.Intent;
import android.net.Uri;
//dengying@20140606 end
...
public class LocationOverlayDemo extends Activity {
	...
	ImageButton requestLocButton = null;//dengying@20140606
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(titleLable);
		//requestLocButton = (ImageButton) findViewById(R.id.my_position_button);//dengying20140606
      ...
      //创建 弹出泡泡图层
        //createPaopao(); //dengying@20140606
